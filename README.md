...
**5 Problems Solved** | **Advanced String Processing & Pattern Matching Algorithms**

- **String compression** using run-length encoding for file compression algorithms
- **Anagram detection** with sliding window and frequency counting for pattern matching
- **Balanced parentheses** using two-pass algorithm with O(1) space complexity
- **Minimum window substring** with advanced sliding window technique for covering problems
- **String beautification** by removing consecutive duplicates for alternating patterns

**Key Algorithms Implemented:**

- Run-Length Encoding (String Compression)
- Sliding Window with Frequency Maps (Anagram Detection, Min Window)
- Two-Pass Validation (Balanced Parentheses)
